...
Source JSON: [Notebooks/R/benchmark_literature_comparison_r_results.json](https://github.com/Arnime/givp/blob/main/Notebooks/R/benchmark_literature_comparison_r_results.json)
