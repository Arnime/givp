...
Source JSON: [Notebooks/Julia/results_notebook_julia.json](https://github.com/Arnime/grasp_ils_vnd_pr/blob/main/Notebooks/Julia/results_notebook_julia.json)
