...
Source JSON: [Notebooks/Rust/benchmark_literature_comparison_rust_results.json](https://github.com/Arnime/givp/blob/main/Notebooks/Rust/benchmark_literature_comparison_rust_results.json)
