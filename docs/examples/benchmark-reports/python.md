...
Source JSON: [Notebooks/Python/benchmark_literature_comparison_results.json](https://github.com/Arnime/grasp_ils_vnd_pr/blob/main/Notebooks/Python/benchmark_literature_comparison_results.json)
